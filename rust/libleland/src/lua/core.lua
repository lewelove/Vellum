...
function __LELAND_GET_CONFIG() return REGISTRY.config end
function __LELAND_GET_COVERS() return REGISTRY.covers end
function __LELAND_GET_INTERFACES() return REGISTRY.interfaces end
function __LELAND_GET_ACTIONS() return REGISTRY.actions end
function __LELAND_GET_DEPENDENCIES()
    local deps = {}

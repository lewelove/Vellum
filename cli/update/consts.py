...
ALBUM_TAGS = [
    ...
    "MUSICBRAINZ_ALBUMARTISTID", "MUSICBRAINZ_RELEASEGROUPID", "MUSICBRAINZ_ALBUMID"
]
...
# HELPERS (snake_case)
ALBUM_HELPERS = [
    "album_root_path", "metadata_toml_hash", 
    "unix_added", "date_added", 
    "album_duration_in_ms", "album_duration_time",
